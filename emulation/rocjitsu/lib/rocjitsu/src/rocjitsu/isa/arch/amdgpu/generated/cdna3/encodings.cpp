...
bool Vop1::has_encoded_dpp() const {
  ...
  return inst_.op <= 1 || (inst_.op >= 5 && inst_.op <= 8) || (inst_.op >= 10 && inst_.op <= 14) ||
         ...
         (inst_.op >= 77 && inst_.op <= 79) || inst_.op == 82 || (inst_.op >= 84 && inst_.op <= 87);
}
...
bool Vop2::has_encoded_dpp() const {
  if (!(inst_.src0 == amdgpu::SRC_DPP))
    return false;
  return inst_.op <= 21 || (inst_.op >= 25 && inst_.op <= 35) || (inst_.op >= 38 && inst_.op <= 61);
}
...
bool Vop3::displays_vop3_op_sel() const {
  return (inst_.op >= 20 && inst_.op <= 21) || (inst_.op >= 32 && inst_.op <= 63) ||
         ...
         (inst_.op >= 406 && inst_.op <= 407) || (inst_.op >= 490 && inst_.op <= 492) ||
         (inst_.op >= 494 && inst_.op <= 495) || (inst_.op >= 497 && inst_.op <= 498) ||
         (inst_.op >= 500 && inst_.op <= 508) || (inst_.op >= 515 && inst_.op <= 519) ||
         (inst_.op >= 665 && inst_.op <= 666) || (inst_.op >= 670 && inst_.op <= 672) ||
         (inst_.op >= 674 && inst_.op <= 675);
}
