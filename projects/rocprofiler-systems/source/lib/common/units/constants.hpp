...
// Raw integer unit constants retained for APIs that accept int64_t unit tokens
// (e.g. timer::get_frequency(units::sec), timemory component ::unit() setters).
// For new code, prefer the type-safe types in common/units/units.hpp.
...
// Data size (base: bytes, SI decimal)
