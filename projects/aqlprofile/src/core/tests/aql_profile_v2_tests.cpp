...
TEST_F(AqlProfileV2Test, BlockNameEnum) {
    ...
    EXPECT_EQ(AQLPROFILE_BLOCK_NAME_DF, HSA_VEN_AMD_AQLPROFILE_BLOCKS_NUMBER);
    EXPECT_EQ(AQLPROFILE_BLOCK_NAME_PCIE_TX_TXCLK, HSA_VEN_AMD_AQLPROFILE_BLOCKS_NUMBER + 1);

    // Test that new block names are defined
    EXPECT_GT(AQLPROFILE_BLOCK_NAME_CHA, AQLPROFILE_BLOCK_NAME_PCIE_LC_TXCLK);
