...
/// @file Address calculation stubs for CDNA1 memory instructions.
///
/// Phase A stubs — implementations are placeholders. Phase B will provide
/// correct address calculation logic shared with the CDNA3 implementation.
...
/// @brief Derive Mtype from sc0/sc1 encoding bits (GFX9 coherency model).
