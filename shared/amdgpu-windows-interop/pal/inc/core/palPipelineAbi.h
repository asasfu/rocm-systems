...
enum GfxIpStepping : uint16
{
    ...
    GfxIpSteppingAlphaTrion2_A0 = 0, //# AlphaTrion2
    GfxIpSteppingAlphaTrion2_B0 = 1,
#if PAL_CLIENT_INTERFACE_MAJOR_VERSION < 988
    GfxIpSteppingAlphaTrion2    = GfxIpSteppingAlphaTrion2_A0,
#endif
#endif // PAL_BUILD_ALPHA_TRION2
#if PAL_BUILD_AT_LITE3
    // GFXIP 13.1.x steppings:
    GfxIpSteppingAtLite3_A0    = 0xFFFF, //# AtLite3 (Magnus)
    GfxIpSteppingAtLite3_B0    = 0xFFFE,
#if PAL_CLIENT_INTERFACE_MAJOR_VERSION < 988
    GfxIpSteppingAtLite3       = GfxIpSteppingAtLite3_A0,
#endif
